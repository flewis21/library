...
const nav_middle_search_box_input = HtmlService.createHtmlOutput(
  `.nav-middle .search-box input {width: 400px;border: 0;outline: 0;background: transparent;}`,
);
...
const shortcuts_links_a = HtmlService.createHtmlOutput(
  `.shortcut-links a {display: flex;align-items: center;margin-bottom; 20px; width: fix-content;flex-wrap: wrap;}`,
);
