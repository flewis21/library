function surveyPlayer(searchString, joinString) {
  ...
  = new YT.Player('player1', {height: '100%',width: '535',playerVars: {'autoplay': 1,'loop': 1,'controls': 0,'rel': 0,'autohide': 1,'playsinline': 0,'mute': 0,'modestbranding': 1,'vq': 'hd1080','rel': 0,'iv_load_policy': 3,'cc_load_policy': 1},events: {'onReady': onPlayerReady,'onStateChange': onPlayerStateChange,'onError': onPlayerError}})};var playlistIndex 
  = 0
