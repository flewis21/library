...
// console.log(data[1])
// webAppUrls: ContentApp.appContent("<? var webAppUrls = navBar(\"https://www.sec.gov/files/company_tickers.json\", \"Edgar\", \"https://avaddc.com/agency/the-paul-rue-agency/4022/\", \"Defensive Driving\") ?><?!= webAppUrls ?>")
...
function newEPAData(rawData) {
  ...
  if (uniqueCoArray.length === 0) {
    ...
    var randomCo =
      uniqueCoKey[1]["items"][randomCoKey] || uniqueCoKey[1]["items"];
    return randomCo;
  }
  // var data = []
