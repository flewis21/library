...
var epaData = function(e) 
  {var urlProduct = "https://script.google.com/macros/s/AKfycbzhrxdXzM08AAwA5ualRXdnDtV6C_xQ7bcq4v6H0HNdBqPr2C8A1URyWN0FLLccQuoA/exec?func=epaData&args="
  var urlIngredient = "https://script.google.com/macros/s/AKfycbzhrxdXzM08AAwA5ualRXdnDtV6C_xQ7bcq4v6H0HNdBqPr2C8A1URyWN0FLLccQuoA/exec?func=epaIng&args="
  var urlCalendar = "https://script.google.com/macros/s/AKfycbzhrxdXzM08AAwA5ualRXdnDtV6C_xQ7bcq4v6H0HNdBqPr2C8A1URyWN0FLLccQuoA/exec?func=dateTime&args="
  var urlPlay = "https://script.google.com/macros/s/AKfycbzhrxdXzM08AAwA5ualRXdnDtV6C_xQ7bcq4v6H0HNdBqPr2C8A1URyWN0FLLccQuoA/exec?func=misBing&args="
  var rndMathArr = [`${randomSubstance(null,null,2)} ${randomSubstance(null,null,2)}`];
  var rndMathProduct = [e][0] || rndMathArr.toString().split(" ")[Math.floor(Math.random() * (Math.floor(rndMathArr.toString().split(" ").length)))];
  ...
  var product = [e][0] || arrayMath.toString().split(" ")[Math.floor(Math.random() * (Math.floor(arrayMath.toString().split(" ").length)))];;
 ...
 for (var i=0,l=test2["active_ingredients"].length; i<l; i++)
    ...
    var ingArray = uniqueData[Math.floor(Math.random() * (Math.floor(uniqueData.length)))]
    if (ingArray) {

    if (typeof ingArray[0]["productname"] === "undefined") {
    var ingTitle = ingArray[0]["rndTitle"]}}
    var randNum = Math.floor(Math.random() * (Math.floor(ingArray.length)));
  ...
  HtmlService.createHtmlOutput(`
    <link href="https://cdnjs.cloudflare.com/ajax/libs/materialize/1.0.0/css/materialize.min.css" rel="stylesheet"></link>`).getContent();
  ...
  html.materializeJs = 
  HtmlService.createHtmlOutput(`
    <script src="https://cdnjs.cloudflare.com/ajax/libs/materialize/1.0.0/js/materialize.min.js"></script>`).getContent();
  html.rule = rule;
  html.ex1 = timeNow;
  html.ex2 = dateNow;
  html.ex3 = nameStatus;
...
var epaIng = function(e)
  ...
  var product = [e][0] || res.toString().split(" ")[Math.floor(Math.random() * (Math.floor(res.toString().split(" ").length)))];;
  var randNum = Math.floor(Math.random() * (Math.floor(res["items"].length)));
  var coTable = res["items"].map((r)=>{return `<tr><td><a class="waves-effect waves-light btn" href="${urlIngredient + encodeURIComponent(r["ingredientname"])}" target="_blank">${r["ingredientname"]}</a></td><td><a class="waves-effect waves-light btn" href="${urlPlay + encodeURIComponent(r["registrationstatus"])}" target="_blank">${r["registrationstatus"]}</a></td><td><a class="waves-effect waves-light btn" href="${urlPlay + encodeURIComponent(r["productnamestatus"])}" target="_blank">${r["productnamestatus"]}</a></td><td><a class="waves-effect waves-light btn" href="${urlCalendar + encodeURIComponent(r["productstatusdate"])}" target="_blank">${r["productstatusdate"]}</a></td><td><a class="waves-effect waves-light btn" href="${urlProduct + encodeURIComponent(r["productname"])}" target="_blank">${r["productname"]}</a></td></tr>`});
  var result = JSON.stringify(coTable);
...
var oldEPA = function(rndTitle)
  {var urlPlayer = "https://script.google.com/macros/s/AKfycbzhrxdXzM08AAwA5ualRXdnDtV6C_xQ7bcq4v6H0HNdBqPr2C8A1URyWN0FLLccQuoA/exec?func=misBing&args=";
  var urlProduct = "https://script.google.com/macros/s/AKfycbzhrxdXzM08AAwA5ualRXdnDtV6C_xQ7bcq4v6H0HNdBqPr2C8A1URyWN0FLLccQuoA/exec?func=misBing&args=";
  var urlEpaRegNo = "https://script.google.com/macros/s/AKfycbzhrxdXzM08AAwA5ualRXdnDtV6C_xQ7bcq4v6H0HNdBqPr2C8A1URyWN0FLLccQuoA/exec?func=misBing&args=";
  var urlCasNo = "https://script.google.com/macros/s/AKfycbzhrxdXzM08AAwA5ualRXdnDtV6C_xQ7bcq4v6H0HNdBqPr2C8A1URyWN0FLLccQuoA/exec?func=misBing&args=";
  var urlPcCode = "https://script.google.com/macros/s/AKfycbzhrxdXzM08AAwA5ualRXdnDtV6C_xQ7bcq4v6H0HNdBqPr2C8A1URyWN0FLLccQuoA/exec?func=misBing&args=";
  var arrayMath = [`acme`]
  var product = rndTitle || arrayMath.toString().split(" ")[Math.floor(Math.random() * (Math.floor(arrayMath.toString().split(" ").length)))];;
  var test = productNamePartial(product);
  var test2 = productRegNo(test["eparegno"]);
  var uniqueCo = [] 
  try {if (test2 && test2["active_ingredients"].length > 0) {
  ...
  var rndIng = Math.floor(Math.random() * (Math.floor(test2["active_ingredients"].length)));
  // var uniqueCo = productIngName(test2["active_ingredients"][rndIng]["active_ing"])
  var productRnD = test2["active_ingredients"][0]["active_ing"] || uniqueCo.toString().split(" ")[Math.floor(Math.random() * (Math.floor(uniqueCo.toString().split(" ").length)))];}
    else {for (var key in test) {uniqueCo.push(test[key])}}}catch(error){if (uniqueCo.length > 0) {
...
function()
  ...
  var linkFollow = document.createElement("a");
  linkFollow.href = url + "?func=oldEPA" + "&args=" + encodeURIComponent(uname);
  linkFollow.id = "linkFOLLOW";
  linkFollow.target = "_top";
  document.body.appendChild(linkFollow);
  document.getElementById("linkFOLLOW").click();
  document.getElementById("username").value = "";})()}; //Global object closed
      return html.evaluate().getContent()}
      else {
...
var productTime = function(product)
  ...
  console.log(" information: ")
  console.log(test6)
    var dataSheetName = `product` + " " + new Date().toDateString() + " " + new Date().toTimeString();
  console.log(dataSheetName.split("(").shift())}

var productRegNo = function(eparegno)
  {const res = [urlDataSource("https://ordspub.epa.gov/ords/pesticides/ppls/" + eparegno, null, {muteHttpExceptions:true})]
...
var productDistNum = function(distno)
  {const rawData = Utilities.jsonParse([urlDataSource("https://ordspub.epa.gov/ords/pesticides/pplsdist/" + encodeURIComponent(distno), null, {muteHttpExceptions:true})])
  return newEPAData(rawData)}

var productFullName = function(productName)
  {const rawData = Utilities.jsonParse([urlDataSource("https://ordspub.epa.gov/ords/pesticides/pplstxt/" + encodeURIComponent(productName), null, {muteHttpExceptions:true})])
  return newEPAData(rawData)}

var productDist = function(epaAUrl, epaDUrl, epaDXpath, epaDDelimiter, dVar, eVar, fVar, iVar, jVar){

  const productDistEpaData = 
    // epaA(
      // GVar(epaAUrl) 
      epaD(
        AVar(epaDUrl), BVar(epaDXpath), CVar(epaDDelimiter)
        )
        // [DVar(dVar)]
        // [EVar(eVar)]
        // [FVar(fVar)]
...
var productName = function(epaDaVar, epaDbVar, epaDcVar, dVar, eVar, fVar){
  ...
  const productNameEpaData = epaD(AVar(epaDaVar), BVar(epaDbVar), CVar(epaDcVar))[DVar(dVar)][EVar(eVar)][FVar(fVar)];
  return productNameEpaData
}

var productNamePartial = function(productName)
  {const res = [urlDataSource("https://ordspub.epa.gov/ords/pesticides/ProductSearch/partialprodsearch/riname/" + productName, null, {muteHttpExceptions:true})];
  if (res[0].indexOf("DOCTYPE") === -1) {
    try 
      {if (res[0]["items"] === []) 
        {return res[0]["first"][0];}
...
var productNamePartialV2 = function(productName)
  {const rawData = Utilities.jsonParse([urlDataSource("https://ordspub.epa.gov/ords/pesticides/cswu/ProductSearch/partialprodsearch/v2/riname/" + encodeURIComponent(productName), null, {muteHttpExceptions:true})])
  return newEPAData(rawData)}

var productNumPartial = function(productNum)
  {const rawData = Utilities.jsonParse([urlDataSource("https://ordspub.epa.gov/ords/pesticides/ProductSearch/partialprodsearch/regnum/" + encodeURIComponent(productNum), null, {muteHttpExceptions:true})])
  return newEPAData(rawData)}

var productNumPartialV2 = function(productNum)
  {const rawData = Utilities.jsonParse([urlDataSource("https://ordspub.epa.gov/ords/pesticides/cswu/ProductSearch/partialprodsearch/v2/regnum/" + encodeURIComponent(productNum), null, {muteHttpExceptions:true})])
  return newEPAData(rawData)}

var productIngName = function(ingredient)
  {var res = [urlDataSource("https://ordspub.epa.gov/ords/pesticides/ProductSearch/searchWithIngName/v1/" + ingredient, null, {muteHttpExceptions:true})];
  if (res[0].indexOf("DOCTYPE") === -1) {
  try 
    {if (res[0]["items"] === []) 
        {return res[0]["first"][0];}
...
var productChemCode = function(code)
  {const res = [urlDataSource("https://ordspub.epa.gov/ords/pesticides/ProductSearch/searchWithPcCode/v1/" + encodeURIComponent(code), null, {muteHttpExceptions:true})];
  if (res[0].indexOf("DOCTYPE") === -1) {
  try 
    {if (res[0]["items"] === []) 
        {return res[0]["first"][0];}
...
var productAbstractNum = function(abstract)
  {const res = [urlDataSource("https://ordspub.epa.gov/ords/pesticides/ProductSearch/searchWithCasNum/v1/" + encodeURIComponent(abstract), null, {muteHttpExceptions:true})]
  if (res[0].indexOf("DOCTYPE") === -1) {
  try 
    {if (res[0]["items"] === []) 
        {return res[0]["first"][0];}
