...
functionRegistry.startProcessTimer();const customOrder = ["e","t","a","o","n","r","i","s","h","d","l","f","c","m","u","g","y","p","w","b","v","k","x","j","q","z"];
...
const arrToSort = ["e","t","a","o","n","r","i","s","h","d","l","f","c","m","u","g","y","p","w","b","v","k","x","j","q","z"];
arrToSort.sort((a, b) => {
    const priorityA = charPriority.get(a);
    const priorityB = charPriority.get(b);
    return priorityA - priorityB;
