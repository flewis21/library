...
var donorsChoice = function() {
  ...
  webApp = testJSON(testData(jsonXpath("https://www.sec.gov/files/company_tickers.json")));
    webApp.content = jsonINIT("https://www.brighttalk.com/webcast/19371/546972?player-preauth=kzSDXpxDKGb23OkAQ2MUQtzW1pSkBUbzaaJVpG66h0k%3D&utm_source=brighttalk-promoted&utm_medium=email&utm_term=Audience400648&utm_campaign=AUD-12113&utm_content=2022-08-5");
    ...
    return HtmlService.createTemplate(`
      ...
      <?!= includeBlob("index").getContent(); ?>`).evaluate().getContent()//:contentFile('uiAccess');
}
