var checkDay = function()
  {var testList = jsonXpath(`https://www.bing.com/search?q=site%3Ayoutube.com&PC=U316&FORM=CHROMN`)
  ...
  var openTheForm = 
    contentFile("popUpOpen"
    , {
      openPopup: "".concat("function openTheForm() {\n  document.getElementById(\"popupForm\").style.display = \"block\";\n}",""),
      closePopup: "".concat("function closeTheForm() {\n  document.getElementById(\"popupForm\").style.display = \"none\";\n}",""),
      startPageUrl: startPageUrl 
      });
  // let result;
