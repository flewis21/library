...
//             return webApp.evaluate().setXFrameOptionsMode(HtmlService.XFrameOptionsMode.ALLOWALL);
        case "iframeJSON": // <!---------------------JSON API Results--------------------------!>
            webApp = HtmlService.createHtmlOutput(jsonINIT("https://www.clubhouse.com/@fabianlewis?utm_medium=ch_profile&utm_campaign=lhTUtHb2bYqPN3w8EEB7FQ-247242"));
            webApp.url = getUrl(ScriptApp);
            return renderTemplate(contentApp("\n   <body id=\"test\">                 \n<h2 class=\"search-overlay__section-title\">\n  General Information\n</h2>\n<ul class=\"link-list min-list\">\n <li>\n    <a href=\"#\">".concat(webApp.getContent(), "</a>\n </li>\n</ul>\n<div class=\"container row s1 valign-wrapper video-container black darken-4\">\n  <div id=\"player1\"></div>\n</div>\n<div class=\"container row s2 valign-wrapper video-container black darken-4\">\n  <div id=\"player2\"></div>\n</div>\n<div class=\"container row s2 valign-wrapper video-container black darken-4\">\n  <div id=\"player3\"></div>\n<script>\n document.addEventListener(\"DOMContentLoaded\", <?!= appJs ?>);\n</script>\n</div>\n </body>\n                              "), {
...
//             return HtmlService.createTemplate("\n                    <?!= include(\"index\"); ?>\n                    <h2 class=\"search-overlay__section-title\">General Information</h2>\n                    <ul class=\"link-list min-list\">\n                      <li><div class=\"query-results\"><a href=\"#\">".concat(webApp.getRawContent(), "</a></div></li>                  \n                    </ul>\n                    <div class=\"clubhouse\">".concat(webApp.content, "</div>\n                    <script>\n                    document.querySelector(\".search-overlay__section-title\").setAttribute(\"style\", \"background-color: red;color: white;\")\n                    document.querySelector(\".query-results\").setAttribute(\"style\", \"background-color: red; color: yellow;\")\n                    </script>\n                    "))).evaluate().setXFrameOptionsMode(HtmlService.XFrameOptionsMode.ALLOWALL);
        default: // <!-----------------------------Default Website---------------------------------!>
            ...
            return contentApp("\n\n <?!= html ?>\n\n  "
            , { 
              html: "".concat(contentApp("\"".concat(navBar(baseUrl, "Finance"), "\"</div><div class=\"clubhouse\"></div>"))
            , "")
            })//:contentFile('uiAccess');
  ...
  var funcCalc = function() {
    ...
    while (rndArrVals.length < appList.length) {
      rndArrVals.push(appList[Math.floor(Math.random() * (Math.floor(appList.length))).valueOf()])
    }
    return rndArrVals
  }
...
var sheetWebsite = function(e)
  ...
  else {var query = usr.parameter["args"] || Math.floor(Math.random() * (Math.floor(e.length)));}
  var urlSs = "https://docs.google.com/spreadsheets/d/1-vNcN0vCLcXgMY9uwcKukUgv_4njggRZ6fqoZs-hBFE/edit#gid=138098962";
  var urlWww = "https://script.google.com/macros/s/AKfycbzhrxdXzM08AAwA5ualRXdnDtV6C_xQ7bcq4v6H0HNdBqPr2C8A1URyWN0FLLccQuoA/exec?func=misBing&args="
  var tmp = []
  ...
  if (arrData) {const keys = Object.keys(arrData);
  ...
  return HtmlService.createTemplate(`
    ...
    <input type="hidden" value="<?= getUrl(ScriptApp) ?>" id="url" />`).getRawContent();}
    // case "request": // <!-----------------------------API Endpoint Page------------------------!>
    // console.log(query)
  // let lastrow = sheet.getLastRow();
  // console.log(data)
