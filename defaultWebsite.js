...
function functionFlex(e) {
  ...
  if (!handles["exec"] && !handles["args"]) {
    ...
    // // Logging
    // if (e && e.parameter && (e.parameter["func"] || e.parameter["file"])) {
    //   Logger.log(">>> [LIBRARY] LIBRARY WEB APP CLIENT REQUEST: " + JSON.stringify(e));
    // } else {
    //   Logger.log(
    //     ">>> [LIBRARY] LIBRARY WEB APP No e.parameter[" +
    //       e?.parameter["func"] +
    //       "] " +
    //       JSON.stringify(e),
    //   );
    ...
    //     };
    //   }
    base = createFunctionResult(libFunc, funcDos);
  }
        ...
        return RenderTemplate.templateRender(
            ...
            </script>`,
          {
            renBlob: ContentApp.appContent(
                ...
                <body id="JavaScript">
                  ...
                  <script>
                    ...
                    try { 
                      ...
                      // }
                      // else 
                      // Here, if dataOR.data is an object, you need to decide how to display it.
              ...
              {
                appL:
                  dataOR.type === "text" ? iframeSrc : JSON.stringify(dataOR),
